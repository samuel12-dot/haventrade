...
export default function SignInScreen({ navigate }) {
  ...
  return (
    <div className="min-h-screen bg-canvas relative md:grid md:grid-cols-2">
      ...
      <div className="hidden md:flex grad grad-terracotta flex-col justify-between relative overflow-hidden" style={{ padding: '96px 56px 56px', color: 'var(--canvas)', minHeight: '100vh' }}>
        ...
        <div className="relative z-[1] flex justify-center my-8">
          <div className="max-w-[360px] w-full rounded-2xl" style={{ transform: 'rotate(2deg)', boxShadow: '0 24px 56px rgba(31,20,16,0.28)' }}>
            <ListingCard listing={teaser} onClick={() => {}} />
          </div>
        </div>

        <div className="relative z-[1] max-w-[460px]">
          <div className="font-mono text-[10px] tracking-widest-2" style={{ color: 'rgba(251,246,236,0.7)' }}>
